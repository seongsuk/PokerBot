...
namespace OddsGridApp
{
    class LoadCard
    {
        ...
        public Queue<String> loadCardFromFile()
        {
            ...
            //{
             //   ll[i].Text = "";
            //}
            var ResourceManager = new System.Resources.ResourceManager("OddsGridApp.Properties.Resources",
    ...
    (BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic))
                {
                    if (i <= 4 && i >= 0)
                    {
                        if (property.Name.Length == 1) //Shape
                        {
                            ...
                            if (checker.bigContainsSmall() != pointNull)
                            {
                              //  ll[shapeCount].ForeColor = System.Drawing.Color.Black;
